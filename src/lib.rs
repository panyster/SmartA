...
#[derive(Debug)]
pub struct SmartAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SmartAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SmartAPI processing");
    
    let mut processor = SmartAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SmartAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SmartAPIProcessor::new(false);
